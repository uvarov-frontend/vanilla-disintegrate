...
A second operation requested for the same element while the first is active resolves as `rejected`. It does not change the DOM or allocate a retention ID.
