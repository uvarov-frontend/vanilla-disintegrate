...
They are VBR stereo MP3: `dust` and `christmas-wind` are encoded around 200 kbps, `scatter` around 290 kbps. Each is trimmed to just over the length of the animation it belongs to and carries a baked-in fade at both ends.
