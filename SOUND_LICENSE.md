...
`src/sounds/dust.mp3`, `src/sounds/vapor.mp3`, `src/sounds/scatter.mp3` and `src/sounds/wind.mp3` are original sounds created and owned by Yury Uvarov. All are distributed as part of Vanilla Disintegrate under the same MIT License as the source code.
